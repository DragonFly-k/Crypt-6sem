...
message = 'SYATKOVSKAYAKATSIARYNADMITRIEVNA'
alphabet = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'
left_rotor = 'BDFHJLCPRTXVZNYEIWGAKMUSQO'
middle_rotor = 'FSOKANUERHMBTIYCWLQPZXVGJD'
right_rotor = 'VZBRGITYUPSDNHLXAWMJQOFECK'
reflector = {
    'A': 'R',
    'B': 'D',
    'C': 'O',
...
def enigma(message : str, left_rotor : str, middle_rotor : str, right_rotor : str) -> str:
    ...
    for character in message:
        ...
        middle_rotor = middle_rotor[1:] + middle_rotor[:1]
